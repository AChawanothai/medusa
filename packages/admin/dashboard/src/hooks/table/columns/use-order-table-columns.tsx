...
import { PaymentProviderCell, PaymentProviderHeader } from "../../../components/table/table-cells/order/payment-provicer-cell";
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("payment_status", {
        header: () => <PaymentProviderHeader />,
        cell: ({ getValue }) => {
          const channel = getValue();

          return <PaymentProviderCell />;
        },
      }),
      columnHelper.accessor("payment_status", {
